...
### Added
- Opt-in affected-area mini-map for CAP alerts (#181) (65535d6…)
...
- Add detail section visibility toggles (#122) (493fea5…)
- Add section dividers to group related controls (#123) (f910b2f…)

### Documentation
- Fix documentation drift and remove dead i18n keys (#121) (afa99f4…)
