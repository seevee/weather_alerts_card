...
export const fr: TranslationMap = {
  ...
  'editor.provider_inmet': 'INMET (Brésil)',
  ...
  'editor.provider_colors': 'Utiliser les couleurs publiées par le fournisseur',
  ...
  'editor.max_distance_helper': "N'afficher que les incidents situés à moins de cette distance du lieu de votre installation Home Assistant, ou de l'entité de position définie ci-dessous. S'applique aux flux d'incidents ponctuels (NSW RFS) — les alertes de zone n'ont pas de distance et ne sont jamais filtrées.",
  'editor.my_location_entity': 'Ma position',
  'editor.my_location_entity_helper': 'Un traceur d\'appareil, une personne ou une zone dont les coordonnées remplacent le lieu de Home Assistant comme point de référence de la carte — pour le marqueur « Ma position » et comme origine du filtre de distance maximale. Utilisez une zone pour un emplacement fixe.',
  ...
  'editor.show_my_location': 'Afficher ma position sur la carte',
  ...
  'editor.section_advanced': 'Avancé',
  'editor.detail_sections': 'Sections',
  'editor.panel_more': '+{count} de plus',
  'editor.option_default': '{label} (par défaut)',
  'editor.reset_default': 'Rétablir la valeur par défaut',
  'editor.also_set': 'Également défini : {names}',
