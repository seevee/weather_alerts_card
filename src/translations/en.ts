...
export const en: TranslationMap = {
  ...
  'editor.provider_inmet': 'INMET (Brazil)',
  ...
  'editor.provider_colors': 'Use the provider\'s published alert colors',
  ...
  'editor.max_distance': 'Maximum distance ({unit})',
  'editor.max_distance_helper': 'Only show incidents within this distance of your Home Assistant home location, or of the location entity set below. Applies to point-incident feeds (NSW RFS) — area warnings have no distance and are never filtered.',
  'editor.my_location_entity': 'My location',
  'editor.my_location_entity_helper': 'A device tracker, person, or zone whose coordinates replace the Home Assistant home location as the card\'s reference point — for the "My location" marker and as the origin of the maximum-distance filter. Use a zone for a fixed location.',
  'editor.animations': 'Enable animations',
  'editor.enhance_contrast': 'Enhance contrast',
  'editor.enhance_contrast_off': 'Off',
  'editor.enhance_contrast_subtle': 'Subtle',
  ...
  'editor.show_my_location': 'Show my location on the map',
  ...
  'editor.tap_action_helper': 'Setting any tap action replaces the inline expand affordance on each alert row.',
  'editor.tap_default': 'Inline expand (default)',
  'editor.tap_details': 'Detail pop-up',
  'editor.tap_more_info': 'More info',
  'editor.tap_navigate': 'Navigate',
  'editor.tap_url': 'Open URL',
  'editor.tap_toggle': 'Toggle',
  'editor.tap_perform_action': 'Perform action',
  'editor.tap_call_service': 'Call service (legacy)',
  'editor.tap_fire_dom_event': 'Fire DOM event',
  'editor.tap_none': 'Nothing',
  'editor.tap_navigation_path': 'Navigation path',
  'editor.tap_url_path': 'URL',
  'editor.tap_yaml_managed': 'This action carries a payload the visual editor does not edit. Its existing YAML is preserved — edit it in the YAML editor.',
  'editor.tap_details_expand_hint': 'With "Always expand details" off, the pop-up opens with its description behind the Read Details toggle.',
  ...
  'editor.option_default': '{label} (default)',
  'editor.reset_default': 'Reset to default',
  'editor.also_set': 'Also set: {names}',
