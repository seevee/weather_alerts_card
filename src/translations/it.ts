...
export const it: TranslationMap = {
  ...
  'editor.provider_inmet': 'INMET (Brasile)',
  ...
  'editor.max_distance_helper': 'Mostra solo gli incidenti entro questa distanza dalla posizione della tua installazione Home Assistant, o dall\'entità di posizione impostata qui sotto. Si applica ai feed di incidenti puntuali (NSW RFS) — le allerte di area non hanno una distanza e non vengono mai filtrate.',
  'editor.my_location_entity': 'La mia posizione',
  'editor.my_location_entity_helper': 'Un device tracker, una persona o una zona le cui coordinate sostituiscono la posizione di Home Assistant come punto di riferimento della scheda: per il marcatore «La mia posizione» e come origine del filtro di distanza massima. Usa una zona per una posizione fissa.',
  ...
  'editor.show_my_location': 'Mostra la mia posizione sulla mappa',
  ...
  'editor.section_source': 'Sorgente',
  ...
  'editor.section_advanced': 'Avanzate',
  'editor.detail_sections': 'Sezioni',
  'editor.panel_more': '+{count} altri',
  'editor.option_default': '{label} (predefinito)',
  'editor.reset_default': 'Ripristina il valore predefinito',
  'editor.also_set': 'Impostati anche: {names}',
