...
export const es: TranslationMap = {
  ...
  'editor.sort_distance': 'Distancia',
  ...
  'editor.provider_colors': 'Usar los colores publicados por el proveedor',
  ...
  'editor.max_distance_helper': 'Mostrar solo los incidentes situados a menos de esta distancia de la ubicación de tu Home Assistant, o de la entidad de ubicación indicada abajo. Se aplica a los feeds de incidentes puntuales (NSW RFS): las alertas de área no tienen distancia y nunca se filtran.',
  'editor.my_location_entity': 'Mi ubicación',
  'editor.my_location_entity_helper': 'Un rastreador de dispositivo, persona o zona cuyas coordenadas sustituyen la ubicación de Home Assistant como punto de referencia de la tarjeta: para el marcador «Mi ubicación» y como origen del filtro de distancia máxima. Usa una zona para una ubicación fija.',
  ...
  'editor.show_my_location': 'Mostrar mi ubicación en el mapa',
  ...
  'editor.devices_missing_warning': 'No se encontró ningún dispositivo para {ids}. ¿Se eliminó la integración?',
  ...
  'editor.section_advanced': 'Avanzado',
  'editor.detail_sections': 'Secciones',
  'editor.panel_more': '+{count} más',
  'editor.option_default': '{label} (predeterminado)',
  'editor.reset_default': 'Restablecer el valor predeterminado',
  'editor.also_set': 'También definido: {names}',
