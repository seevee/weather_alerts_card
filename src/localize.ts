...
const zhHans: TranslationMap = {
  // Card UI
  'card.no_alerts': '当前无活动警报',
  'card.sources_unavailable_named': '{name} 不可用',
  'card.sources_unavailable_count': '{count} 个数据源不可用',
  'card.sources_unavailable_one': '有 1 个数据源不可用',
  'card.preview': '示例数据',
  'card.read_details': '查看详情',
  'card.open_source': '打开 {provider} 数据源',
  ...
  'detail.instructions': '应对指引',

  // Progress bar
  'progress.start': '开始',
  'progress.now': '当前',
  'progress.end': '结束',
  'progress.ongoing': '持续中',
  'progress.expires_in_label': '剩余有效时间',
  'progress.starts_in_label': '距离生效还有',
  'progress.tbd': '待定',
  'progress.na': '不适用',
  'progress.expired_label': '已过期',
  'progress.compact_active': '持续 {time}',
  'progress.compact_prep': '{time} 后生效',
  'progress.compact_ongoing': '持续中',
  'progress.compact_expired': '{time}前已过期',

  // Relative time
  'time.just_now': '刚刚',
  'time.in_less_than_1m': '不到1分钟后',
  ...
  'editor.provider_cap': 'CAP 警报（多地区）',
  'editor.device': 'CAP 警报设备（可选）',
  'editor.device_helper': '自动拉取此设备下所有活动警报传感器。',
  'editor.zones': '区域（可选）',
  'editor.zones_helper': '逗号分隔的 BoM area_id 代码，例如 NSW_FL049',
  'editor.event_codes': '事件代码（可选）',
  'editor.event_codes_helper': '逗号分隔的事件代码，例如 TOW、SVW（NWS）或 31、95（DWD）',
  'editor.exclude_event_codes': '排除事件代码（可选）',
  'editor.exclude_event_codes_helper': '要排除的逗号分隔事件代码，例如 SCY（NWS）或 22（DWD）',
  'editor.sort_order': '排序方式',
  'editor.sort_default': '默认',
  'editor.sort_onset': '按生效时间',
  'editor.sort_severity': '按严重程度',
  'editor.color_theme': '配色主题',
  'editor.color_severity': '按严重程度着色（默认）',
  'editor.color_nws': 'NWS 官方配色',
  'editor.color_meteoalarm': 'MeteoAlarm 预警配色',
  'editor.color_eccc': 'ECCC 公共警报配色',
  'editor.timezone': '时区',
  'editor.tz_server': '服务器（Home Assistant）',
  'editor.tz_browser': '浏览器（本地设备）',
  'editor.min_severity': '最低严重程度',
  'editor.severity_all': '全部级别',
  'editor.severity_minor': '轻微及以上（Ⅳ级，蓝色）',
  'editor.severity_moderate': '中等及以上（Ⅲ级，黄色）',
  'editor.severity_severe': '严重及以上（Ⅱ级，橙色）',
  'editor.severity_extreme': '仅极端（Ⅰ级，红色）',
  'editor.animations': '启用动画',
  'editor.enhance_contrast': '增强对比度',
  'editor.enhance_contrast_off': '关闭',
  'editor.enhance_contrast_subtle': '柔和（默认）',
  'editor.enhance_contrast_strict': '严格（WCAG AA 标准）',
  ...
  'editor.show_instructions': '显示应对指引',
  ...
  'editor.show_source_link': '显示数据源链接',
  ...
  'editor.progress_fill': '进度条填充',
  'editor.progress_fill_track': '轨道（细条）',
  'editor.progress_fill_background': '背景色块',
  'editor.styling_section': '进度条与图标样式',
  'editor.progress_style': '进度条装饰',
  'editor.progress_style_wash_note': '当“进度条填充”设为“背景色块”时不生效（色块始终为纯色）。',
  'editor.progress_style_preparation': '准备阶段',
  'editor.progress_style_active': '激活状态',
  'editor.progress_style_ongoing': '持续状态',
  'editor.deco_solid': '纯色',
  'editor.deco_striped': '条纹',
  'editor.deco_shimmer': '微光',
  'editor.deco_pulse': '脉冲',
  'editor.icon_border_style': '图标边框样式',
  'editor.icon_border_dashed': '虚线',
  'editor.icon_border_solid': '实线',
  'editor.hide_expired': '隐藏已过期的警报',
  'editor.hide_no_alerts': '无活动警报时隐藏卡片',
  'editor.unavailable_behavior': '数据源不可用时',
  'editor.unavailable_message': '显示具体哪个数据源',
  'editor.unavailable_compact': '显示紧凑指示器',
  'editor.unavailable_hide': '隐藏指示器（不推荐）',
  'editor.unavailable_hide_warning': '隐藏指示器可能在数据源断开时误报安全——传感器不可用并不代表没有风险。',
  'editor.allow_dismiss': '允许忽略警报',
  'editor.show_dismiss_undo': '忽略时显示撤销提示',
  ...
  'editor.preview_nudge': '当前无活动警报——启用此项以预览卡片布局。',
  'editor.entity_warning': '所选实体似乎不包含天气警报数据。',
  'editor.no_entities_hint': '未找到支持的天气警报实体。请先安装对应的提供商集成（如 NWS Alerts）。',
  'editor.no_entities_hint_link': '支持的提供商列表',
  'editor.feeds': '从已安装的订阅源自动收集',
  'editor.feeds_helper': '检测到集成订阅源。勾选后即可包含其上报的所有实时事件——无需逐个列出实体。需要先在 Home Assistant 中配置对应集成。',
  'editor.source_hint': '正从订阅源自动收集 {count} 个实时事件——无需手动添加实体。',
  'editor.feeds_missing_warning': '{feeds} 暂无实时数据。此订阅源已启用但没有数据输入——请检查是否已在 Home Assistant 中正确配置该集成？',
  'editor.no_device_alerts_hint': '此设备下暂未发现活动警报传感器。当 CAP Alerts 发布警报时，卡片将自动填充数据。',

  // Editor section labels
  'editor.section_entity': '实体与提供商',
  'editor.section_filtering': '过滤条件',
  'editor.section_appearance': '外观设置',
  'editor.section_detail_panel': '详情面板',
  'editor.section_behavior': '行为设置',
  'editor.section_dismissal': '忽略设置',
