      ...
      <div class="progress-section">
        <div class="progress-labels">
          ...
          <div class="label-center">
            ${i?r?B`expires <b>${Mt(s,a)}</b>`:B`starts <b>${Mt(o,a)}</b>`:B`<span style="color: var(--color);"><b>Ongoing</b></span>`}
          </div>
