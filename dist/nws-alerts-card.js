...
`;let Wt=class extends se{setConfig(e){this._config=e}_fireConfigChanged(e){this._config=e;const t=new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0});this.dispatchEvent(t)}_entityChanged(e){const t=e.detail.value;t!==this._config.entity&&this._fireConfigChanged({...this._config,entity:t})}_titleChanged(e){const t=e.target.value;if(t===(this._config.title||""))return;const r={...this._config};t?r.title=t:delete r.title,this._fireConfigChanged(r)}_providerChanged(e){const t=e.target.value;if(t===(this._config.provider||"auto"))return;const r={...this._config};"auto"===t?delete r.provider:r.provider=t,this._fireConfigChanged(r)}_animationsChanged(e){const t=e.target.checked;if(t===(!1!==this._config.animations))return;const r={...this._config};t?delete r.animations:r.animations=!1,this._fireConfigChanged(r)}_layoutChanged(e){const t=e.target.checked;if(t===("compact"===this._config.layout))return;const r={...this._config};t?r.layout="compact":delete r.layout,this._fireConfigChanged(r)}_zonesChanged(e){const t=e.target.value,r={...this._config};t.trim()?r.zones=t.split(",").map(e=>e.trim()).filter(Boolean):delete r.zones,this._fireConfigChanged(r)}_sortOrderChanged(e){const t=e.target.value;if(t===(this._config.sortOrder||"default"))return;const r={...this._config};"default"===t?delete r.sortOrder:r.sortOrder=t,this._fireConfigChanged(r)}_colorThemeChanged(e){const t=e.target.value;if(t===(this._config.colorTheme||"severity"))return;const r={...this._config};"severity"===t?delete r.colorTheme:r.colorTheme=t,this._fireConfigChanged(r)}render(){if(!this.hass||!this._config)return B``;const e=this._config.zones?this._config.zones.join(", "):"";return B`
      <div class="editor">
        <ha-selector
          .hass=${this.hass}
  ...
  `,e([he({attribute:!1})],Wt.prototype,"hass",void 0),e([pe()],Wt.prototype,"_config",void 0),Wt=e([le("nws-alerts-card-editor")],Wt);const Gt={nws:"NWS",bom:"BoM"};let Yt=class extends se{constructor(){super(...arguments),this._expandedAlerts=new Map,this._motionQuery=window.matchMedia("(prefers-reduced-motion: reduce)"),this._onMotionChange=()=>this.requestUpdate()}connectedCallback(){super.connectedCallback(),this._motionQuery.addEventListener("change",this._onMotionChange)}disconnectedCallback(){super.disconnectedCallback(),this._motionQuery.removeEventListener("change",this._onMotionChange)}setConfig(e){if(!e.entity)throw new Error("You need to define an entity");this._config=e}getCardSize(){const e=this._getAlerts(),t=this._isCompact?1:3;return Math.max(1,e.length*t)}static getConfigElement(){return document.createElement("nws-alerts-card-editor")}static getStubConfig(){return{entity:"sensor.nws_alerts_alerts"}}_getAlerts(){if(!this.hass||!this._config)return[];const e=this.hass.states[this._config.entity];if(!e)return[];const t=function(e,t){if(e){const t=Bt.find(t=>t.provider===e);if(t)return t}for(const e of Bt)if(e.canHandle(t))return e;return Bt[0]}(this._config.provider,e.attributes);let r=t.parseAlerts(e.attributes);if(this._config.zones&&this._config.zones.length>0){const e=new Set(this._config.zones.map(e=>e.toUpperCase()));r=r.filter(t=>{return r=e,t.zones.some(e=>r.has(e.toUpperCase()));var r})}return function(e,t){return"onset"===t?[...e].sort((e,t)=>(e.onsetTs||1/0)-(t.onsetTs||1/0)):"severity"===t?[...e].sort((e,t)=>{const r=(Pt[e.severity]??4)-(Pt[t.severity]??4);return 0!==r?r:(e.onsetTs||1/0)-(t.onsetTs||1/0)}):e}(r,this._config.sortOrder||"default")}get _locale(){return{...this.hass.locale,timeZone:this.hass.config?.time_zone}}get _animationsEnabled(){return!0===this._config?.animations||!1!==this._config?.animations&&!this._motionQuery.matches}get _isCompact(){return"compact"===this._config?.layout}get _colorTheme(){return this._config?.colorTheme||"severity"}_alertColorStyle(e){if("nws"!==this._colorTheme||"nws"!==e.provider)return"";const{color:t,rgb:r,textColor:n}=function(e){const t=e.toLowerCase();for(const[e,r,n]of Et)if(e.some(e=>t.includes(e)))return{color:r,rgb:n,textColor:Ct(r)};return{color:"#808080",rgb:"128, 128, 128",textColor:Ct("#808080")}}(e.event);return`--color: ${t}; --color-rgb: ${r}; --badge-text: ${n};`}_normalizeText(e){return(e||"").replace(/\n{2,}/g,"\n\n").trim()}_toggleDetails(e){const t=new Map(this._expandedAlerts);t.set(e,!t.get(e)),this._expandedAlerts=t}_sourceLinkLabel(e){return`Open ${Gt[e.provider]||"Alert"} Source`}render(){if(!this._config||!this.hass)return B``;const e=this.hass.states[this._config.entity];if(!e)return B`
    ...
    `}_renderAlert(e){const t=`severity-${e.severity}`,r=function(e){const t=Date.now()/1e3,r=e.sentTs,n=r>0?r:t;let i=e.onsetTs;0===i&&(i=n);const o=i+3600;let s=e.endsTs;0===s&&(s=o);const a=e.endsTs>0,l=t>=i;let c,d,h,p;l?(c=i,d=s,h=t,p="Active"):(c=t,d=s,h=i,p="Preparation");const u=d-c,m=(h-c)/(u>0?u:1)*100;return{isActive:l,phaseText:p,progressPct:Math.max(0,Math.min(100,Math.round(10*m)/10)),remainingHours:Math.round((s-t)/3600*10)/10,onsetHours:Math.round((i-t)/3600*10)/10,onsetMinutes:Math.round((i-t)/60),onsetTs:i,endsTs:s,sentTs:r,nowTs:t,hasEndTime:a}}(e),n=r.phaseText.toLowerCase(),i=this._expandedAlerts.get(e.id)||!1;return this._isCompact?this._renderCompactAlert(e,t,n,r,i):this._renderFullAlert(e,t,n,r,i)}_renderCompactAlert(e,t,r,n,i){return B`
      <div class="alert-card ${t} ${r}" style=${this._alertColorStyle(e)}>
        ...
        ${i?this._renderExpandedContent(e,n):W}
      </div>
    ...
    `}_renderFullAlert(e,t,r,n,i){return B`
      <div class="alert-card ${t} ${r}" style=${this._alertColorStyle(e)}>
        ...
        <div class="alert-details-section">
          ...
          ${i?this._renderDetailsContent(e,n):W}
        </div>
      </div>
      ...
      <div class="details-content">
        <div class="meta-grid">
          ...
          <div class="meta-item">
            ...
            ${t.hasEndTime?B`<span class="meta-relative">${Rt(t.endsTs,t.nowTs)}</span>`:W}
          </div>
        </div>
